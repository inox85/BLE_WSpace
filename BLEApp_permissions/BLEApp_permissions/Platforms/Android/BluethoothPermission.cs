...
namespace BLEApp_permissions.Platforms.Android
{
    public partial class BluetoothPermissions : Permissions.BasePlatformPermission
    {
        ...
        public override (string androidPermission, bool isRuntime)[] RequiredPermissions
        {
            get
            {
                ...
                var androidContext = Platform.AppContext;

                var sdk = (int)androidContext.ApplicationContext?.ApplicationInfo?.TargetSdkVersion;
